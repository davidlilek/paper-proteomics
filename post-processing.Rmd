...
params:
  ...
  path:
    label: "File path"
    value: "X:/wissenschaftliche Veröffentlichungen/Publikationen/2022/Proteomics_JRS_DL/data/proteinGroups/results_run1_mqpar_extracts_2gether_D2_combined_txt_proteinGroups.txt"
  pathRDS:
    label: "File path RDS file"
    value: "X:/wissenschaftliche Veröffentlichungen/Publikationen/2022/Proteomics_JRS_DL/data/"
  unique: 
