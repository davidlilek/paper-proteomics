...
plot(mean_samples[-31],sd_samples[-31]/mean_samples[-31]*100,main="relative standard deviation vs. protein number",ylab="rel sd [%]",xlab="number proteins")
...
data_raw <- data_raw[[1]]
E5_D1 <- dplyr::select(data_raw, contains("1_"))
