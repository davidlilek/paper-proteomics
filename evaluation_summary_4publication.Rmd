...
ggvenn(lst,
       fill_color = c(D1_col,D2_col),
       stroke_size = 0.5, set_name_size = 4, text_size = 4, digits = 0, fill_alpha = 0.9)
euler_venn_2comp(lst, label_venn = c("D1\ningeldigest_pool", "D2\ningeldigest_pool"), color_venn = c(D1_col,D2_col), cex_venn = c(1,1), h_just = 0.5, v_just = 0.5)
```
...
euler_venn_3comp(lst, label_venn = c("E3","E4","E5"), color_venn = c(IG,highMW,lowMW), cex_venn = c(1,1,1), h_just = 0.5, v_just = 0.5)
