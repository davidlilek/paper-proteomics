...
* proteaseinhibitor funktioniert am besten deshalb alle weiteren experimente mit protease inhibitor
* AF/TF/B: in gel digest liefert die besten ergebnisse
verschiedene dimensionen bringen was weil wir immer wieder "neue" proteine finden
* besser fraktionieren als pool messen
  + das sieht man sowohl bei E4_D1 als auch bei E4_D2
  + ist das auch eine limitierung des lc-ms/ms systems, weil man kann ja nicht unendlich viele proteine in einem lauf messen?
* E5: auch wenn D3 und D4 dort sehr wenige Proteine zeigen bringt es was da man in Summe wieder neue Proteine findet

## outlook 

* reproduzierbarkeit testen: man sieht ja bei `file://fhwn.ac.at/TU/Forschung/wissenschaftliche%20Ver%C3%B6ffentlichungen/Publikationen/2022/Proteomics_JRS_DL/data/evaluation_summary_4publication.html#61_compare_E4_D1_Pool_G_B1-B9_and_E4_D1_Pool_20_B1-B9` dass es zwischen biologischen(?) replikaten teilweise noch größere unterschiede ist; wie hoch sind diese schwankungen auch bei anderen extraktionen?
* wieso korrelieren proteinmassen in den Fraktionen B1-B9 (fast) nicht mit den markerbanden? es sollte ja zumindest iene gewisse auftrennung geben, die aber in real nicht wirklich beobachtet wurde
...
euler_venn_3comp(lst, label_venn = c("B","AF","TF"), color_venn = c(IG,lowMW,highMW), cex_venn = c(1,1,1), h_just = 0.5, v_just = 0.5)
...
euler_venn_2comp(lst, label_venn = c("B","E4_D1_pool"), color_venn = c(IG,total), cex_venn = c(1,1), h_just = 0.5, v_just = 0.5)
...
euler_venn_2comp(lst, label_venn = c("pool_G","pool_20"), color_venn = c(D1_col,D2_col), cex_venn = c(1,1), h_just = 0.5, v_just = 0.5)
```
...
### E4_D1_Pool_G_B1-B9 with E4_D2_Pool_20_B1-B9
...
euler_venn_2comp(lst, label_venn = c("D1\ningeldigest_fraction","D2\ningeldigest_fraction"), color_venn = c(D1_col,D2_col), cex_venn = c(1,1), h_just = 0.5, v_just = 0.5)
...
ggvenn(lst,
       fill_color = c(D1_col,D2_col),
       stroke_size = 0.5, set_name_size = 4, text_size = 4, digits = 0, fill_alpha = 0.9)
euler_venn_2comp(lst, label_venn = c("D1_ingeldigest_fraction","D2_ingeldigest_fraction"), color_venn = c(D1_col,D2_col), cex_venn = c(1,1), h_just = 0.5, v_just = 0.5)
```
...
euler_venn_3comp(lst, label_venn = c("D1_a","D2_a","D3_a"), color_venn = c(IG,highMW,lowMW), cex_venn = c(1,1,1), h_just = 0.5, v_just = 0.5)
```
...
euler_venn_3comp(lst, label_venn = c("D1_b","D2_b","D3_b"), color_venn = c(IG,highMW,lowMW), cex_venn = c(1,1,1), h_just = 0.5, v_just = 0.5)
```
...
# combine to list
lst <- list("E4"=as.double(E4_inter[,1]),
            "E5"=as.double(E5_inter[,1]))
...
euler_venn_2comp(lst, label_venn = c("E4","E5"), color_venn = c(E4_col,E5_col), cex_venn = c(1,1,1), h_just = 0.5, v_just = 0.5)
...
comparison$E5_D4 <- as.logical(comparison$E5_D2)
...
lst <- list("E4_D2"=as.double(E4_inter[,1]),
            "E5_D2"=as.double(E5_inter[,1]),
            "E5_D4"=as.double(E5_4_inter[,1]))
...
euler_venn_3comp(lst, label_venn = c("E4_D2","E5_D2","E5_D4"), color_venn = c(IG, highMW, lowMW), cex_venn = c(1,1,1), h_just = 0.5, v_just = 0.5)
```
...
euler_venn_2comp(lst, label_venn = c("E4_D2","E5_D2D4"), color_venn = c(E4_col,E5_col), cex_venn = c(1,1,1), h_just = 0.5, v_just = 0.5)
...
euler_venn_3comp(lst, label_venn = c("E3","E4","E5"), color_venn = c(E4_col,E5_col), cex_venn = c(1,1,1), h_just = 0.5, v_just = 0.5)
...
* manuel von hier abgeschrieben `file:///X:/wissenschaftliche%20Ver%C3%B6ffentlichungen/Publikationen/2022/Proteomics_JRS_DL/data/evaluation_summary_4publication.html#9_D2`
