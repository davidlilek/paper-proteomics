...
euler_venn_3comp(lst, label_venn = c("CIT","PHOS","CAR"), color_venn = c(col1,col2,col3), cex_venn = c(1,1,0.70,0.9,0,1,1), h_just = 0.5, v_just = 0.5)
```
...
sd(subset(data_sub,group=="noTreatment")[,1])
...
sd(subset(data_sub,group=="ProteaseInhibitor")[,1])
...
euler_venn_3comp(lst, label_venn = c("E5_D1_b","E5_D2_b","E5_D4_b"), color_venn = c(IG,highMW,lowMW), cex_venn = c(1,1,1,1,0,1,1),
...
euler_venn_3comp(lst, 
                 label_venn = c("E4_D1_B","E4_D1_AF","E4_D1_TF"),
                 color_venn = c(IG,lowMW,highMW), 
                 cex_venn = c(1,
                              0.7,
                              0.5,
                              0.8,
...
euler_venn_2comp(lst, label_venn = c("E4_D1_B_fractions","E4_D1"), color_venn = c(IG,total), cex_venn = c(1,0.6,1), h_just = 0.5, v_just = 0.5)
...
euler_venn_2comp(lst, label_venn = c("D2_fractions","D2_pool"), color_venn = c(D2_pool_col,D2_ingel_col), cex_venn = c(1,0.6,1), h_just = 0.5, v_just = 0.5)
