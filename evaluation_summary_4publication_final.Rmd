...
euler_venn_2comp(lst, label_venn = c("D1-electrophoretic fractionation","D1-total protein extract"), color_venn = c(col_X_light, col_X_dark), cex_venn = c(1,0,1), h_just = 0.5, v_just = 0.5)
...
euler_venn_2comp(lst, label_venn = c("D2-electrophoretic fractionation","D2-total protein extract"), color_venn = c( col_Y_light,col_Y_dark), cex_venn = c(1,0.0,1), h_just = 0.5, v_just = 0.5)
