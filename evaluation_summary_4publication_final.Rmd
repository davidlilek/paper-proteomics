...
euler_venn_3comp(lst, label_venn = c("Citrate buffer pH 4.8", "Phosphate buffer pH 8","Carbonate buffer pH 10.8"),
                 color_venn = c(col2,col_X_dark,col3), cex_venn = c(0.85,1,0.5,0.75,0,1,1), h_just = 0.5, v_just = 0.5)
...
# Grafik 4 - SDS Page Identifiaktionen
...
# Grafik 5 - Bioinformatic Data Analysis

## A

```{r, fig.width=4,fig.height=4}

# von hier file:///X:/wissenschaftliche%20Ver%C3%B6ffentlichungen/Publikationen/2022/Proteomics_JRS_DL_stillgelegt%20und%20transferiert%20auf%20Teams_230605/Data/evaluation_summary_unique.html
data <- read.csv("Extraktionen_gesamt_V2_DL.csv", sep=";")
# unique vs razor
...
par(mar = c(3.9,4, 1, 1))
boxplot(MBR, noMBR, ylab = "Deviation Razor-Unique [%]", names = c("MBR", "noMBR"))
...
par(mar = c(3.9,4, 1, 1))
plot(mean_unique,unique, xlab= "Number of identified proteins", ylab="Deviation MBR [%]")
...
par(mar = c(3.9,4, 1, 1))
plot(mean_noMBR,noMBR, xlab= "Number of identified proteins", ylab="Deviation Razor vs. Unique peptides [%]")
...
```{r, fig.width=4,fig.height=4}
# aus file:///X:/wissenschaftliche%20Ver%C3%B6ffentlichungen/Publikationen/2022/Proteomics_JRS_DL_stillgelegt%20und%20transferiert%20auf%20Teams_230605/Data/evaluation_summary_4publication.html
data <- read.csv("Extraktionen_gesamt_V2_DL.csv", sep=";")
