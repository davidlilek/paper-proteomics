...
* D1 und D2 wurden gemerged und sind im Diagramm als PHO bezeichnet dargestellt
...
euler_venn_2comp(lst, label_venn = c("AIO","PHO"), color_venn = c(AIO_col,PHO_col), cex_venn = c(1,1), h_just = 0.5, v_just = 0.5)
