...
BP[is.na(BP[,3])==TRUE,1]
BP_4ggplot <- melt(BP)
#BP_4ggplot$Function_short <- substr(BP_4ggplot$Function,1,15)
BP_4ggplot <- BP_4ggplot %>%
  mutate(Function_short = extract_goterm(Function))
...
results_comp <- c(results_comp,sum(rowSums(is.na(BP[2:3]))>1,na.rm = TRUE))
...
* wenn ich alle verfügbaren GO Terms nehme bekomme ich...
	+ bei B 21NA = 2.8%
	+ bei AF 363 NA = 48,7%
	+ bei TF 372 NA = 49,9%
	+ in Summe 745 GO Terms wenn man es prozentuell rechnen will
* wenn ich alle verfügbaren GO Terme die mehr als 1x vorkommen bekomme ich
	+ bei B 21NA = 11,41%
	+ bei AF 69NA = 37,5%
	+ bei TF 65NA = 35,32%
	+ bei einer Summe von 184 GO Terms
* wenn ich nur die ersten 100 nehme
	+ bei B 52NA =  50,48%
	+ bei AF 52NA = 50,48%
	+ bei TF 52NA = 50,48%
	+ bei einer Summe von 103 GO Terms
* wenn ich nur die ersten 20 nehme
	+ bei B 9 NA = 31% 
	+ bei AF 9 NA = 31%
	+ bei TF 9 NA = 31%
	+ bei einer Summe von 29 GO Terms


## versuch von 2D und 3D
* wenn ich alle verfügbaren GO Terms nehme bekomme ich...
	+ bei 2D 96NA = 16,63%
	+ bei 3D 36NA = 6,23%
	+ in Summe 577 GO Terme wenn mans es prozentuell berechnen will
* wenn ich alle verfügbaren GO Terme die mehr als 1x vorkommen bekomme ich
	+ bei 2D 96NA=49,48%
	+ bei 3D 96NA=49,48%
	+ in Summe 194 GO Terme
* wenn ich nur die ersten 100 nehme bekomme ich...
	+ bei 2D 18NA = 15,25%
	+ bei 3D 18NA = 15,25%
	+ bei 118 GO Termen
* wenn ich nur die ersten 20 nehme bekomme ich...
	+ bei 2D 3 NA = 13,04%
	+ bei 3D 3 NA = 13,04%
	+ bei 23 GO Termen
