...
############## B
data <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_B_combined_txt_proteinGroups.txt_Razor.RDS")
data <- data[[1]]
...
############AF
data <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_AF_TF_combined_txt_proteinGroups.txt_Razor.RDS")
data <- data[[1]]
...
#################### MBR
data <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_B_MBR_combined_txt_proteinGroups.txt_Razor.RDS")
data <- data[[1]]
data_sub <- dplyr::select(data, contains("Pool_G"))
#get rid of FALSE values
B <- data_sub*1
...
############AF
data <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_AF_TF_MBR_combined_txt_proteinGroups.txt_Razor.RDS")
data <- data[[1]]
data_sub <- dplyr::select(data, contains("Pool_AF"))
#get rid of FALSE values
AF <- data_sub*1
...
AF_TF_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_AF_TF_combined_txt_proteinGroups.txt_Razor.RDS")
AF_TF_raw <- AF_TF_raw[[1]]
AF <- dplyr::select(AF_TF_raw, contains("AF"))
AF <- apply(AF, 1, any)
AF <- as.data.frame(cbind(AF, AF_TF_raw$FASTA))
TF <- dplyr::select(AF_TF_raw, contains("TF"))
TF <- apply(TF, 1, any)
TF <- as.data.frame(cbind(TF, AF_TF_raw$FASTA))
B_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_B_combined_txt_proteinGroups.txt_Razor.RDS")
B_raw <- B_raw[[1]]
B <- dplyr::select(B_raw, contains("Pool_G"))
B <- apply(B, 1, any)
B <- as.data.frame(cbind(B, B_raw$FASTA))
...
aj <- apply(aj, 1, any)
aj <- as.data.frame(cbind(aj, aj_raw$FASTA))
