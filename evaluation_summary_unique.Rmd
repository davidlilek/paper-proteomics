...
############## B
data <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_B_combined_txt_proteinGroups.txt_Unique.RDS")
data <- data[[1]]
...
############AF
data <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_AF_TF_combined_txt_proteinGroups.txt_Unique.RDS")
data <- data[[1]]
...
#################### MBR
data <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_B_MBR_combined_txt_proteinGroups.txt_Unique.RDS")
data <- data[[1]]
data_sub <- dplyr::select(data, contains("Pool_G"))
#get rid of FALSE values
B <- data_sub*1
...
############AF
data <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_AF_TF_MBR_combined_txt_proteinGroups.txt_Unique.RDS")
data <- data[[1]]
data_sub <- dplyr::select(data, contains("Pool_AF"))
#get rid of FALSE values
AF <- data_sub*1
...
AF_TF_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_AF_TF_combined_txt_proteinGroups.txt_Unique.RDS")
...
B_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_B_combined_txt_proteinGroups.txt_Unique.RDS")
B_raw <- B_raw[[1]]
...
B <- apply(B, 1, any)
B <- as.data.frame(cbind(B, B_raw$FASTA))
aj_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_a-j_combined_txt_proteinGroups.txt_Unique.RDS")
aj_raw <- aj_raw[[1]]
...
# D2
###############################
data <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_D2_combined_txt_proteinGroups.txt_Unique.RDS")
data <- data[[1]]
...
D1_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_B_combined_txt_proteinGroups.txt_Unique.RDS")
D1_raw <- D1_raw[[1]]
D1 <- dplyr::select(D1_raw, contains("20"))
D1 <- apply(D1, 1, any)
D1 <- as.data.frame(cbind(D1, D1_raw$FASTA))
D2_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_D2_combined_txt_proteinGroups.txt_Unique.RDS")
D2_raw <- D2_raw[[1]]
