...
boxplot(MBR, noMBR, ylab = "Deviation Razor vs. Unique peptides [%]", names = c("MBR", "noMBR"))
...
plot(mean_MBR,MBR, xlab= "Number of identified proteins", ylab="Deviation Razor vs. Unique peptides [%]")
...
plot(mean_razor,razor, xlab= "Number of identified proteins", ylab="Deviation MBR [%]", main = "Razor")
plot(mean_unique,unique, xlab= "Number of identified proteins", ylab="Deviation MBR [%]", main="Unique")
median(unique[which(mean_unique>=200)])
median(unique[which(mean_unique<200)])
```
