...
AF_TF_raw <- readRDS(file = "results_v002/results_run1_mqpar_extracts_2gether_E4_D1_AF_TF_MBR_LFQ_combined_txt_proteinGroups.txt_LFQ.RDS")
...
B_raw <- readRDS(file = "results_v002/results_run1_mqpar_extracts_2gether_E4_D1_B_MBR_LFQ_combined_txt_proteinGroups.txt_LFQ.RDS")
B_raw <- B_raw[[1]]
FASTA <- B_raw$FASTA
B_raw[] <- B_raw > 0
...
ggsave("./pics/LFQ_MBR_AF_TF_B.png")
...
B <- apply(B, 1, any)
B <- as.data.frame(cbind(B, FASTA))
aj_raw <- readRDS(file = "results_v002/results_run1_mqpar_extracts_2gether_E4_D1_a-j_MBR_LFQ_combined_txt_proteinGroups.txt_LFQ.RDS")
aj_raw <- aj_raw[[1]]
FASTA <- aj_raw$FASTA
aj_raw[] <- aj_raw > 0
...
ggsave("./pics/LFQ_MBR_B_D1pool.png")
...
# D2
###############################
data <- readRDS(file = "results_v002/results_run1_mqpar_extracts_2gether_D2_MBR_LFQ_combined_txt_proteinGroups.txt_LFQ.RDS")
data <- data[[1]]
data[] <- data > 0
data[is.na(data)]<- FALSE  
...
D1_raw <- readRDS(file = "results_v002/results_run1_mqpar_extracts_2gether_E4_D1_B_MBR_LFQ_combined_txt_proteinGroups.txt_LFQ.RDS")
D1_raw <- D1_raw[[1]]
FASTA <- D1_raw$FASTA
D1_raw[] <- D1_raw > 0
...
D2_raw <- readRDS(file = "results_v002/results_run1_mqpar_extracts_2gether_D2_MBR_LFQ_combined_txt_proteinGroups.txt_LFQ.RDS")
D2_raw <- D2_raw[[1]]
FASTA <- D2_raw$FASTA
D2_raw[] <- D2_raw > 0
