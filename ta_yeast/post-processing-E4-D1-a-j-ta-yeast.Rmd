...
params:
  ...
  path:
    label: "File path"
    value: "X:/wissenschaftliche Veröffentlichungen/Publikationen/2022/Proteomics_JRS_DL/data/proteinGroups/2gether_E4_D1_a-j_ta_yeast_proteinGroups.txt"
  pathRDS:
    label: "File path RDS file"
    value: "X:/wissenschaftliche Veröffentlichungen/Publikationen/2022/Proteomics_JRS_DL/data/ta_yeast/results/"
  unique: 
...
* used Razor peptides and at least 2 peptides for identification
