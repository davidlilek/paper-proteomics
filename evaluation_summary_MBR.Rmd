...
AF_TF_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_AF_TF_MBR_combined_txt_proteinGroups.txt_Razor.RDS")
...
B_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_B_MBR_combined_txt_proteinGroups.txt_Razor.RDS")
B_raw <- B_raw[[1]]
...
B <- apply(B, 1, any)
B <- as.data.frame(cbind(B, B_raw$FASTA))
aj_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_a-j_MBR_combined_txt_proteinGroups.txt_Razor.RDS")
aj_raw <- aj_raw[[1]]
...
# D2
###############################
data <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_D2_MBR_combined_txt_proteinGroups.txt_Razor.RDS")
data <- data[[1]]
...
D1_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_E4_D1_B_MBR_combined_txt_proteinGroups.txt_Razor.RDS")
D1_raw <- D1_raw[[1]]
D1 <- dplyr::select(D1_raw, contains("20"))
D1 <- apply(D1, 1, any)
D1 <- as.data.frame(cbind(D1, D1_raw$FASTA))
D2_raw <- readRDS(file = "results/results_run1_mqpar_extracts_2gether_D2_MBR_combined_txt_proteinGroups.txt_Razor.RDS")
D2_raw <- D2_raw[[1]]
